...
response.setContentType("text/html");
		...
		name=request.getParameter("user_name");
			 ...
			 System.out.print("Pass"+password+name);
			 String strin="Select * from login where username='"+name+"'";
			...
			RequestDispatcher rd=request.getRequestDispatcher("SearchAfterLogin.jsp");
