 ...
 <%
    ...
    <%
               ...
               for(i=0;i<20;i++)
               {
                    ...
                    preference[i][1]=0.0F;
                    //singer gender
                    sin_gen="select singer_gen from qbsh_uploadsong where songid='"+g.weight[i][0]+"'";
                    ...
                    r1.close();
                    q="select max(count(u.singer_gen)) from qbsh_uploadsong u,qbsh_searchhistory s where u.songid=s.songid and s.user_id='"+uid+"' and singer_gen='"+sin_gen+"' group by singer_gen";
                    ...
                    //year of song                      
                    y="select year from qbsh_uploadsong where songid='"+g.weight[i][0]+"'";
                    ...
                    r1.close();
                    q="select max(count(u.year)) from qbsh_uploadsong u,qbsh_searchhistory s where u.songid=s.songid and s.user_id='"+uid+"' and year='"+year+"' group by year";
                    r2=stmt.executeQuery(q);
                    while(r2.next())
                    {
                        y1=r2.getInt(1);
                    ...
                    //genre of song
                    genr="select genre from qbsh_uploadsong where songid='"+g.weight[i][0]+"'";
                    ...
                    r1.close();
                    q="select max(count(u.genre)) from qbsh_uploadsong u,qbsh_searchhistory s where u.songid=s.songid and s.user_id='"+uid+"' and genre='"+genr+"' group by genre";
                    r2=stmt.executeQuery(q);
                    while(r2.next())
                    {
                        genre=r2.getInt(1);
                    ...
                    //tempo of the song
                    temp="select tempo from qbsh_uploadsong where songid='"+g.weight[i][0]+"'";
                    ...
                    r1.close();
                    q="select max(count(u.tempo)) from qbsh_uploadsong u,qbsh_searchhistory s where u.songid=s.songid and s.user_id='"+uid+"' and tempo='"+temp+"' group by tempo";
                    r2=stmt.executeQuery(q);
                    while(r2.next())
                    {
                        tempo=r2.getInt(1);
        ...
        <%
           ...
           int id=0;
            for(i=0;i<20;i++)
            {
                    ...
                    list="select songid,songname from qbsh_uploadsong where songid="+preference[i][0]+"";
